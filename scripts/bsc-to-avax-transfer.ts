...
mkcContract.methods.approve(BRIDGE_BSC_ADDRESS, "5000000000000000000000000000000").send({ from: (web3BSC.currentProvider as HDWalletProvider).getAddress(0) })
try {
    bridgeContract.methods.burn(address, '5000000000000000000').send({ from: address, value: "100000000000000000" })
